...
/*!50106 CREATE*/ /*!50117 DEFINER=`root`@`localhost`*/ /*!50106 EVENT `eventGerarMensalidades` ON SCHEDULE EVERY 5 MINUTE STARTS '2019-11-16 10:05:59' ON COMPLETION NOT PRESERVE ENABLE COMMENT 'Responsável por gerar mensalidades mensalmente' DO BEGIN
  START TRANSACTION;
