...
INSERT INTO `administradors` VALUES (1,'Administrador','IronFit','056.123.125-11','1982-07-14','(73)95543-1256','adminironfit@gmail.com','chefe',1,'2019-12-01 19:19:53','2019-12-18 17:33:43',1),(2,'Novo ','Admin','123.515.743-12','1998-12-13','(99)99129-1244','novoadmin@gmail.com','chefe',1,'2019-12-18 19:19:53','2019-12-18 19:19:53',2);
...
INSERT INTO `clientes` VALUES (3,'Júlia','Santana','Feminino','1996-08-11','123.123.123.44','(22)22222-2222','julia@gmail.com',1,'2019-12-17 11:42:40','2019-12-18 19:24:37',2,1),(6,'Júlio','Santos','Masculino','1999-07-11','412.412.412-41','(14)24124-1241','julio@gmail.com',0,'2019-12-18 19:50:31','2019-12-18 19:50:45',2,1);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`academiaironfit`@`%`*/ /*!50003 TRIGGER novaMensalidade AFTER INSERT
...
BEGIN
  ...
  call primeiraMensalidadeAberta();
...
CREATE TABLE `enderecoacademia` (
  ...
  `uf` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  `AcademiumId` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `enderecoclientes` VALUES (3,'Qualquer','43','São Paulo','Qualquer','12312-314','SP','2019-12-17 11:42:40','2019-12-17 11:46:03',3),(4,'Nova Vida','5123','Nova','Novo','21512-351','AL','2019-12-18 19:50:31','2019-12-18 19:50:31',6);
...
INSERT INTO `logins` VALUES (1,'adminironfit@gmail.com','$2a$10$pwkPmNqou/0UEyjY0ASEFOVpgBVMdsmrR3YLonOuJRnkrKkSzenhu','2019-12-01 19:19:53','2019-12-18 17:33:43',1),(2,'novoadmin@gmail.com','$2a$10$pwkPmNqou/0UEyjY0ASEFOVpgBVMdsmrR3YLonOuJRnkrKkSzenhu','2019-12-01 19:19:53','2019-12-01 19:19:53',2);
...
CREATE TABLE `mensalidadeacademia` (
  ...
  `formaPagamento` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Em aberto',
  `createdAt` datetime NOT NULL,
  `updatedAt` datetime NOT NULL,
  `AcademiumId` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `mensalidades` VALUES (3,50,'2019-12-17','2020-01-16',NULL,NULL,'Em aberto','2019-12-17 11:42:41','2019-12-17 21:22:59',3),(4,50,'2019-12-17','2019-12-17','2019-12-17','Dinheiro','Pago','2019-12-17 11:42:41','2019-12-17 11:42:41',3),(5,50,'2019-12-18','2020-01-17',NULL,NULL,'Em aberto','2019-12-18 19:50:34','2019-12-18 19:50:34',6),(6,50,'2019-12-18','2019-12-18','2019-12-18','Dinheiro','Pago','2019-12-18 19:50:34','2019-12-18 19:50:34',6);
...
/*!50106 CREATE*/ /*!50117 DEFINER=`academiaironfit`@`%`*/ /*!50106 EVENT `eventGerarMensalidades` ON SCHEDULE EVERY 10 SECOND STARTS '2019-12-12 12:47:17' ON COMPLETION NOT PRESERVE ENABLE COMMENT 'Responsável por gerar mensalidades mensalmente' DO BEGIN
  ...
  START TRANSACTION;
    ...
    WHILE @minID <= @maxID DO
      ...
      SET @diaEmissao = (SELECT DAY(@dataEmissao));
      ...
      IF @clienteID > 0 AND @isAtivo = 1 THEN
        ...
        IF @diaEmissao >= @diaAtual AND @mesEmissao != @mesAtual THEN
...
-- Dump completed on 2019-12-18 22:48:23
